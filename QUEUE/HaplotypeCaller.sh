...
$JAVA_QUEUE -S $PWD/HaplotypeCaller.scala -R $HG19 -I bam.list --scatter_gather 80  -qsub   -jobParaEnv smp    -l DEBUG  -jobQueue long.q -memLimit 20  -jobResReq h_vmem=22g   -keepIntermediates
