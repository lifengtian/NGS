...
$JAVA_QUEUE -S $PWD/pipeline.scala -i bam.list --scatter_gather 80  -qsub   -jobParaEnv smp   --bwa_threads 4  -l DEBUG  -jobQueue long.q -memLimit 20  -jobResReq h_vmem=22g  -keepIntermediates  -p projectName
